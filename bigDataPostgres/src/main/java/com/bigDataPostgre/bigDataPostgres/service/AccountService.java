package com.bigDataPostgre.bigDataPostgres.service;

import com.bigDataPostgre.bigDataPostgres.model.Account;
import com.bigDataPostgre.bigDataPostgres.repository.AccountRepository;
...
public class AccountService {
    ...
    public void benchmark(int number) {
        ...
        System.out.println("Benchmark Postgres per " + number + " operazioni:");
